...
public interface ResultSetWrapper extends AutoCloseable {
    ...
    <ObjectValue, ColumnValue> ObjectValue get(int columnIndex, SqlColumnTypedConverter<ObjectValue, ColumnValue> converter);

    <T> T get(String columnName, Class<T> type);

    <ObjectValue, ColumnValue> ObjectValue get(String columnName, SqlColumnTypedConverter<ObjectValue, ColumnValue> converter);
