...
public abstract class AbstractResultSetWrapper implements ResultSetWrapper {
    ...
    @Override
    public <ObjectValue, ColumnValue> ObjectValue get(int columnIndex, SqlColumnTypedConverter<ObjectValue, ColumnValue> converter) {
        try {
    ...
    @Override
    public <ObjectValue, ColumnValue> ObjectValue get(String columnName, SqlColumnTypedConverter<ObjectValue, ColumnValue> converter) {
        try {
