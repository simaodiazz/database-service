...
public abstract class SqlColumnTypedConverter<ObjectValue, ColumnValue>
		implements SqlColumnConverter<ObjectValue, ColumnValue> {

	protected final Class<ObjectValue> objectValueClass;
	protected final Class<ColumnValue> columnValueClass;

	public SqlColumnTypedConverter(
			Class<ObjectValue> objectValueClass, Class<ColumnValue> columnValueClass) {
